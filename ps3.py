...
def substitute_hand(hand, letter):
    ...
    if letter in hand:
        new_letter = random.choice(choise_list)
        hand[new_letter] = hand.pop(letter)
    return hand    
        
# additional function
def single_play(Flag_substitute, Flag_replay):
    hand = deal_hand(HAND_SIZE) 
    print("Current Hand: ", end ='')
    display_hand(hand) 
    if Flag_substitute == True:
    ...
    if Flag_replay == True:
        ...
        if replay_hand == "yes":
            ...
            if score_replay > score:
                score = score_replay
            Flag_replay = False       
    return score, Flag_substitute, Flag_replay    
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    """
    try:
        number_hand = int(input("Enter total number of hands: "))   
    except:
        print("Incorect input of total number of hands")
        return False
    all_total_score = 0    
    Flag_substitute = True
    Flag_replay = True
    for i in range(number_hand):
        score, Flag_substitute, Flag_replay = single_play(Flag_substitute, Flag_replay)
        all_total_score = all_total_score + score
        print("--------")
